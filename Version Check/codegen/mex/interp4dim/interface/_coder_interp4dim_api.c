 ...
 *
 * Code generation for function '_coder_interp4dim_api'
 *
 */
  ...
  msgId))[200000]
{
  ...
  void interp4dim_api(interp4dimStackData *SD, const mxArray * const prhs[12],
                      const mxArray *plhs[1])
{
  ...
  interp4dim(SD, *z, *a, *zind, *probind, *kapind, *V, *X, *Y, *zv, *av, *probd,
             *kapd, *yf);
...
/* End of code generation (_coder_interp4dim_api.c) */
