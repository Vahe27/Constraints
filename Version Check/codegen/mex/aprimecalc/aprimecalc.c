...
void aprimecalc(aprimecalcStackData *SD, const real_T z[15], const real_T a[130],
                ...
                real_T BE[200000], const real_T PB[200000], const real_T WA
                [48750], const real_T NA[48750], const real_T SA[48750], const
                real_T BNA[48750], const real_T BBA[48750], real_T Kmin, real_T
                Kmax, real_T yf[1400000])
{
  int32_T amax;
  int32_T amin;
  int32_T jj;
...
/* End of code generation (aprimecalc.c) */
