...
MAKEFILE = aprimecalc_mex.mk

include aprimecalc_mex.mki
...
MEX_FILE_NAME_WO_EXT = aprimecalc_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\aprimecalc"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\aprimecalc/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\aprimecalc/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\aprimecalc/%.cu
	$(CC) $(CCFLAGS) "$<"
