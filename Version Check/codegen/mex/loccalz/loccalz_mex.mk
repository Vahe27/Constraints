...
MAKEFILE = loccalz_mex.mk

include loccalz_mex.mki
...
MEX_FILE_NAME_WO_EXT = loccalz_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\loccalz"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\loccalz/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\loccalz/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\loccalz/%.cu
	$(CC) $(CCFLAGS) "$<"
