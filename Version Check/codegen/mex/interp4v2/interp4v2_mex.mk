...
MAKEFILE = interp4v2_mex.mk

include interp4v2_mex.mki
...
MEX_FILE_NAME_WO_EXT = interp4v2_mex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\interp4v2"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\interp4v2/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\interp4v2/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\interp4v2/%.cu
	$(CC) $(CCFLAGS) "$<"
