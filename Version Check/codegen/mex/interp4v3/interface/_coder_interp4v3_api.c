 ...
 *
 * Code generation for function '_coder_interp4v3_api'
 *
 */
...
void interp4v3_api(interp4v3StackData *SD, const mxArray * const prhs[23], const
                   mxArray *plhs[1])
{
  real_T (*yf)[1400000];
  real_T (*z)[15];
  ...
  interp4v3(SD, *z, *a, *zind, *probind, *kapind, *V, *X, *Y, *W, *Z, *zv, *av, *
...
/* End of code generation (_coder_interp4v3_api.c) */
