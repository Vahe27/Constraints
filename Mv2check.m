...
% Labor Market Loop Matrices ----------------------------------------------
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 w0         = 0.7; % check whether market will clear in this case
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
distL    = 100;
tolL     = 0.0055;
maxiterL = 25;
...
%{
if iterL == maxiterL && distL>tolL && FLAGUNCLEARL == 0
[ADJ, INDADJ] = min(abs(funcdistL(:,1)));
    FLAGUNCLEARL = 1;
    w0 = funcdistL(INDADJ,2);
    iterL = iterL - 1;
end
%}
end;
