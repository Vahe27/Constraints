...
% consbB  = repmat(reshape(businc(:,:,bneps,:),nz,na,nprob),1,1,1,nap) - ...
%    repmat(reshape(apgrid,1,1,1,nap),nz,na,nprob,1)  - tau;
...
% UbBk = repmat(UbBB,1,1,1,1,nkap); % For those who are already business owners
